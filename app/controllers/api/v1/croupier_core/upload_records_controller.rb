class Api::V1::CroupierCore::UploadRecordsController < Api::V1::BaseController
  ...
  def my_uploads 
    ...
    user_uploads = Domains::CroupierCore::UploadRecord.user_uploads(page, per_page, current_user.id)
