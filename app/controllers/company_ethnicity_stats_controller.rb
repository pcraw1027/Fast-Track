class CompanyEthnicityStatsController < ApplicationController
  ...
  def index
    @company_ethnicity_stats = CompanyEthnicityStat.all
  end
  ...
  def new
    @company_ethnicity_stat = CompanyEthnicityStat.new
  end
  ...
  def create
    @company_ethnicity_stat = CompanyEthnicityStat.new(company_ethnicity_stat_params)
...
notice: "Company ethnicity stat was successfully destroyed."
  ...
  private
    ...
    def set_company_ethnicity_stat
      @company_ethnicity_stat = CompanyEthnicityStat.find(params[:id])
    end
