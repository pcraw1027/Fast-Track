class Domains::Socials::SocialSitesController < ApplicationController
  ...
  def new
    @social_site = Domains::Socials::SocialSite.new
  end
  ...
  def create
    @social_site = Domains::Socials::SocialSite.new(social_site_params)
  ...
  def destroy
    ...
    respond_to do |format|
      format.html do
 redirect_to domains_socials_social_sites_path, status: :see_other, notice: "Social site was successfully destroyed."
      end
  ...
  private
    ...
    def set_social_site
      @social_site = Domains::Socials::SocialSite.find(params[:id])
    end

    # Only allow a list of trusted parameters through.
    def social_site_params
      params.require(:domains_socials_social_site).permit(:site_code, :site)
    end
end
