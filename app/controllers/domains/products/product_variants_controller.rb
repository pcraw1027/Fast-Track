class Domains::Products::ProductVariantsController < ApplicationController
  ...
  def destroy_media
    medium = Domains::Features::Mediable::Medium.find(params[:medium_id])
  ...
  private
    ...
    def set_product_variant
      @product_variant = Domains::Products::ProductVariant.find(params[:id])
    end


    def product_variant_params
      params.require(:domains_products_product_variant).permit(:barcode, media_attributes: [:id, :file, :_destroy])
    end
end
