class Domains::People::EthnicityTypesController < ApplicationController
  ...
  def index
    @ethnicity_types = Domains::People::EthnicityType.all
  end
  ...
  def new
    @ethnicity_type = Domains::People::EthnicityType.new
  end
  ...
  def create
    @ethnicity_type = Domains::People::EthnicityType.new(ethnicity_type_params)
  ...
  def destroy
    ...
    respond_to do |format|
      format.html do
 redirect_to domains_people_ethnicity_types_path, status: :see_other, notice: "Ethnicity type was successfully destroyed."
      end
  ...
  private
    ...
    def set_ethnicity_type
      @ethnicity_type = Domains::People::EthnicityType.find(params[:id])
    end

    # Only allow a list of trusted parameters through.
    def ethnicity_type_params
      params.require(:domains_people_ethnicity_type).permit(:ethnicity, :definition, :source)
    end
end
