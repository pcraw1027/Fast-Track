class Domains::People::GenderTypesController < ApplicationController
  ...
  def new
    @gender_type = Domains::People::GenderType.new
  end
  ...
  def create
    @gender_type = Domains::People::GenderType.new(gender_type_params)
  ...
  def destroy
    ...
    respond_to do |format|
      format.html do
 redirect_to domains_people_gender_types_path, status: :see_other, notice: "Gender type was successfully destroyed."
      end
  ...
  private
    ...
    def set_gender_type
      @gender_type = Domains::People::GenderType.find(params[:id])
    end

    # Only allow a list of trusted parameters through.
    def gender_type_params
      params.require(:domains_people_gender_type).permit(:gender, :definition)
    end
end
