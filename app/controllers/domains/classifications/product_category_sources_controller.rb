class Domains::Classifications::ProductCategorySourcesController < ApplicationController
  ...
  def new
    @product_category_source = Domains::Classifications::ProductCategorySource.new
  ...
  def create
    @product_category_source = Domains::Classifications::ProductCategorySource.new(product_category_source_params)
 ...
 redirect_to @product_category_source, notice: "Product category source was successfully updated."
  ...
  def destroy
    ...
    respond_to do |format|
      format.html do
 redirect_to domains_classifications_product_category_sources_path, status: :see_other, 
notice: "Product category source was successfully destroyed."
  ...
  private
    ...
    def set_product_category_source
      @product_category_source = Domains::Classifications::ProductCategorySource.find(params[:id])
    end

    # Only allow a list of trusted parameters through.
    def product_category_source_params
      params.require(:domains_classifications_product_category_source).permit(:code, :description)
    end
end
