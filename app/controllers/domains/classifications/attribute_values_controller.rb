class Domains::Classifications::AttributeValuesController < ApplicationController
  ...
  def new
    @attribute_value = Domains::Classifications::AttributeValue.new
  end
  ...
  def create
    @attribute_value = Domains::Classifications::AttributeValue.new(attribute_value_params)
  ...
  def destroy
    ...
    respond_to do |format|
      format.html do
 redirect_to domains_classifications_attribute_values_path, status: :see_other, notice: "Attribute value was successfully destroyed."
      end
  ...
  private
    ...
    def set_attribute_value
      @attribute_value = Domains::Classifications::AttributeValue.find(params[:id])
    end
    ...
    def attribute_value_params
      params.require(:domains_classifications_attribute_value).permit(:code, :title, :description, 
