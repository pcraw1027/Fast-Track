class Domains::CroupierCore::UploadRecordsController < ApplicationController
  ...
  def new
    @upload_record = Domains::CroupierCore::UploadRecord.new
  end
  ...
  def destroy
    ...
    respond_to do |format|
      format.html do
 redirect_to domains_croupier_core_upload_records_path, status: :see_other, notice: "Upload record was successfully destroyed."
      end
  ...
  private
    ...
    def set_upload_record
      @upload_record = Domains::CroupierCore::UploadRecord.find(params[:id])
    end

    # Only allow a list of trusted parameters through.
    def upload_record_params
      params.require(:domains_croupier_core_upload_record).permit(:scan_id, :asin, :resolve_status, :date, :barcode, 
      :product_name, :company_name, :brand, :remarks, 
