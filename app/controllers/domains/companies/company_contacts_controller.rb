class Domains::Companies::CompanyContactsController < ApplicationController
  ...
  def index
    @company_contacts = Domains::Companies::CompanyContact.all.paginate(page: params[:page], per_page: 15)
...
id: :desc)
  ...
  def create
    @company_contact = Domains::Companies::CompanyContact.new(company_contact_params)
  ...
  def destroy
    ...
    respond_to do |format|
      format.html do
 redirect_to domains_companies_company_contacts_path, status: :see_other, notice: "Company contact was successfully destroyed."
      end
  ...
  private
    ...
    def set_company_contact
      @company_contact = Domains::Companies::CompanyContact.find(params[:id])
    end

    def set_dropdowns
      @companies = Domains::Companies::Company.all
      @company_contact_types = Domains::Companies::CompanyContactType.all
    end

    # Only allow a list of trusted parameters through.
    def company_contact_params
      params.require(:domains_companies_company_contact).permit(:company_id, :company_contact_type_id, 
