class Domains::WebsiteData::WebsiteMessagesController < ApplicationController
  ...
  def new
    @website_message = Domains::WebsiteData::WebsiteMessage.new
  end
  ...
  def create
    @website_message = Domains::WebsiteData::WebsiteMessage.new(website_message_params)
  ...
  private
    ...
    def set_website_message
      @website_message = Domains::WebsiteData::WebsiteMessage.find(params[:id])
    end

    # Only allow a list of trusted parameters through.
    def website_message_params
      params.require(:domains_website_data_website_message).permit(:sender_name, :sender_email, :message_type, 
      :message_subject, :message_content, :sender_response_sent, :internal_response_sent, :initial_response, 
      :initial_response_date, :conclusion)
    end
end
