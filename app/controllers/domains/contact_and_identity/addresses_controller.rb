class Domains::ContactAndIdentity::AddressesController < ApplicationController
  ...
  # GET /addresses/new
  def new
    @address = Domains::ContactAndIdentity::Address.new
  end
  ...
  def create
    @address = Domains::ContactAndIdentity::Address.new(address_params)
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to domains_contact_and_identity_addresses_path, status: :see_other, notice: "Address was successfully destroyed." }
  ...
  private
    ...
    def set_address
      @address = Domains::ContactAndIdentity::Address.find(params[:id])
    end
