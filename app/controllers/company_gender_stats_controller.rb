class CompanyGenderStatsController < ApplicationController
  ...
  def index
    @company_gender_stats = CompanyGenderStat.all
  end
  ...
  def new
    @company_gender_stat = CompanyGenderStat.new
  end
  ...
  def create
    @company_gender_stat = CompanyGenderStat.new(company_gender_stat_params)
 ...
 redirect_to company_gender_stats_path, status: :see_other, notice: "Company gender stat was successfully destroyed."
  ...
  private
    ...
    def set_company_gender_stat
      @company_gender_stat = CompanyGenderStat.find(params[:id])
    end

    # Only allow a list of trusted parameters through.
    def company_gender_stat_params
      params.require(:company_gender_stat).permit(:company_id, :gender_type_id, :employee_type_id, :count, :percentage)
    end
end
