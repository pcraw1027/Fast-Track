...
ActiveRecord::Schema.define(version: 2026_02_14_122404) do
  ...
  create_table "cit_records", force: :cascade do |t|
    ...
    t.integer "capture_status", default: 0, null: false
    t.index ["capture_status"], name: "index_cit_on_capture_status"
  ...
  create_table "pit_records", force: :cascade do |t|
    ...
    t.index ["capture_status"], name: "index_pit_on_capture_status"
  ...
  create_table "products", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.bigint "product_category_source_id"
    t.bigint "searches", default: 0, null: false
