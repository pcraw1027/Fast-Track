...
var _default = /*#__PURE__*/function (_Controller) {
  ...
  return _createClass(_default, [{
    ...
    value: function initBrickTitleSearch() {
      ...
      console.log("Has segment target?", this.hasSegmentTarget);
      console.log("Has family target?", this.hasFamilyTarget);
      console.log("Has klass target?", this.hasKlassTarget);
      this.selectInstance = new tom_select__WEBPACK_IMPORTED_MODULE_1___default.a(this.element, {
        valueField: 'id',
        labelField: 'title',
        searchField: 'title',
...
/******/ });
//# sourceMappingURL=application-bd81aeebed545ad954bb.js.map