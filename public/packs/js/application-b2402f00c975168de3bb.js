    ...
    value: function connect() {
      ...
      this.selectInstance = new tom_select__WEBPACK_IMPORTED_MODULE_1___default.a(this.element, {
        ...
        onItemAdd: function onItemAdd(value) {
          ...
          if (document.getElementById('person_last_name')) {
            document.getElementById('person_last_name').value = person.first_name;
          }
          if (document.getElementById('person_first_name')) {
            document.getElementById('person_first_name').value = person.last_name;
          }
          if (document.getElementById('person_middle_name')) {
            document.getElementById('person_middle_name').value = person.middle_name;
          }
          if (document.getElementById('person_email')) {
            document.getElementById('person_email').value = person.email;
          }
          if (document.getElementById('person_website')) {
            document.getElementById('person_website').value = person.website;
          }
          if (document.getElementById('person_gender_type_id')) {
            document.getElementById('person_gender_type_id').value = person.gender_type_id;
          }
          if (document.getElementById('person_ethnicity_type_id')) {
            document.getElementById('person_ethnicity_type_id').value = person.ethnicity_type_id;
          }
          if (document.getElementById('person_country_reference_id')) {
            document.getElementById('person_country_reference_id').value = person.country_reference_id;
          }
          if (document.getElementById('person_letters')) {
            document.getElementById('person_letters').value = person.letters;
          }
          if (document.getElementById('person_id')) {
            document.getElementById('person_id').value = person.id;
          }
          if (document.getElementById('person_picture') && person.picture) {
            document.getElementById('person_picture').value = person.picture_url;
            document.getElementById('person_picture').classList.remove("d-none");
          }
...
/******/ });
//# sourceMappingURL=application-b2402f00c975168de3bb.js.map