    ...
    value: function connect() {
      ...
      if (document.readyState === "loading") {
        document.addEventListener("DOMContentLoaded", function () {
          _this.initialize();
          _this.initBrickTitleSearch();
        });
      } else {
        this.initialize();
        this.initBrickTitleSearch();
      }
    }
  }, {
    key: "initBrickTitleSearch",
    value: function initBrickTitleSearch() {
      var _this2 = this;
      if (this.selectInstance) return;
      console.log("initBrickTitleSearch()");
      this.brickCache = {};
      this.selectInstance = new tom_select__WEBPACK_IMPORTED_MODULE_1___default.a(this.element, {
        valueField: 'id',
        labelField: 'title',
        ...
        onItemAdd: function onItemAdd(value) {
          ...
          // console.log("this.hasBrickTarget", this.hasBrickTarget);
          ...
          if (!_this2.segmentSelect && _this2.hasSegmentTarget) {
            _this2.segmentSelect = new tom_select__WEBPACK_IMPORTED_MODULE_1___default.a(_this2.segmentTarget, {
              placeholder: "Select a segment"
            });
          }
          if (!_this2.familySelect && _this2.hasFamilyTarget) {
            _this2.familySelect = new tom_select__WEBPACK_IMPORTED_MODULE_1___default.a(_this2.familyTarget, {
              placeholder: "Select a family"
            });
          }
          if (!_this2.klassSelect && _this2.hasKlassTarget) {
            _this2.klassSelect = new tom_select__WEBPACK_IMPORTED_MODULE_1___default.a(_this2.klassTarget, {
              placeholder: "Select a klass"
            });
          }
          if (!_this2.brickSelect && _this2.hasBrickTarget) {
            _this2.brickSelect = new tom_select__WEBPACK_IMPORTED_MODULE_1___default.a(_this2.brickTarget, {
              placeholder: "Select a brick"
            });
          }
...
/******/ });
//# sourceMappingURL=application-95f0df8e72e6dcfa3ca9.js.map