...
/* harmony import */ var _tabs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./tabs */ "./app/javascript/packs/tabs.js");
...
document.addEventListener("turbolinks:load", function () {
  document.querySelectorAll('[data-toggle="tab"]').forEach(function (tab) {
    console.log("tabe", tab);
    tab.addEventListener("shown.bs.tab", function (event) {
      var url = event.target.dataset.url;
      var paneId = event.target.getAttribute("href");
      var pane = document.querySelector(paneId);
      var container = pane.querySelector(".tab-content-body");

      // Prevent refetching when user reopens the tab
...
/******/ });
//# sourceMappingURL=application-ac86435acc12aec3992f.js.map