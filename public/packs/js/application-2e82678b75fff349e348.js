...
var _default = /*#__PURE__*/function (_Controller) {
  function _default() {
    ...
    _this.segmentSelect = null;
    _this.familySelect = null;
    _this.klassSelect = null;
    _this.brickSelect = null;
    return _this;
  }
  _inherits(_default, _Controller);
  return _createClass(_default, [{
    ...
    value: function initBrickTitleSearch() {
      ...
      this.selectInstance = new tom_select__WEBPACK_IMPORTED_MODULE_1___default.a(this.element, {
        ...
        load: function load(query, callback) {
          ...
          fetch("/bricks_by_title_search?q=".concat(encodeURIComponent(query))).then(function (response) {
            ...
            json.forEach(function (brick) {
              return _this3.brickCache[brick.id] = brick;
            });
        ...
        onItemAdd: function onItemAdd(value) {
          var _this3$brickCache;
          var brick = (_this3$brickCache = _this3.brickCache) === null || _this3$brickCache === void 0 ? void 0 : _this3$brickCache[value];
          if (!brick) return;
          ...
          _this3.brickSelect.addOption({
            value: brick.id,
            text: "".concat(brick.code, " ").concat(brick.title)
          });
          _this3.brickSelect.setValue(brick.id, true);
          _this3.brickSelect.refreshOptions(false);
          _this3.klassSelect.addOption({
            value: brick.klass.id,
            text: "".concat(brick.klass.code, " ").concat(brick.klass.title)
          });
          _this3.klassSelect.setValue(brick.klass.id, true);
          _this3.brickSelect.refreshOptions(false);
          _this3.familySelect.addOption({
            value: brick.family.id,
            text: "".concat(brick.family.code, " ").concat(brick.family.title)
          });
          _this3.familySelect.setValue(brick.family.id, true);
          _this3.familySelect.refreshOptions(false);
          _this3.segmentSelect.addOption({
            value: brick.segment.id,
            text: "".concat(brick.segment.code, " ").concat(brick.segment.title)
          });
          _this3.segmentSelect.setValue(brick.segment.id, true);
          _this3.segmentSelect.refreshOptions(false);
        }
      });
    }
  }, {
...
/******/ });
//# sourceMappingURL=application-2e82678b75fff349e348.js.map