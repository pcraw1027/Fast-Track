...
var map = {
	...
	"./klass_select_controller.js": "./app/javascript/controllers/klass_select_controller.js",
        ...
        return _regenerator().w(function (_context) {
          while (1) switch (_context.n) {
            ...
            case 1:
              ...
              return _context.a(2, this.showError("barcode must be 6, 8, 12, or 13 characters long, symbology UPC-E, EAN-8, UPC-A, or EAN-13."));
            case 2:
              formData = new FormData(); //console.log("Barcode to submit:", barcode); // Debugging line
...
/***/ "./app/javascript/controllers/klass_select_controller.js":
/*!***************************************************************!*\
  !*** ./app/javascript/controllers/klass_select_controller.js ***!
  \***************************************************************/
/*! exports provided: default */
  ...
  return _createClass(_default, [{
    ...
    value: function connect() {
      ...
      this.selectInstance = new tom_select__WEBPACK_IMPORTED_MODULE_1___default.a(this.element, {
        ...
        load: function load(query, callback) {
          if (!query.length) return callback();
          fetch("/klasses_search?q=".concat(encodeURIComponent(query))).then(function (response) {
            return response.json();
          }).then(function (json) {
            return json.map(function (c) {
              return {
                id: c.id,
                title: "".concat(c.code, " - ").concat(c.title)
              };
            });
          }).then(function (res) {
            return callback(res);
    ...
    value: function connect() {
      ...
      this.selectInstance = new tom_select__WEBPACK_IMPORTED_MODULE_1___default.a(this.element, {
        ...
        onItemAdd: function onItemAdd(value) {
          ...
          var str = _this.element.id;
          var idStr = str.replace(/_person_id$/, '');
          if (document.getElementById("".concat(idStr, "_first_name"))) {
            document.getElementById("".concat(idStr, "_first_name")).value = person.first_name;
          }
          if (document.getElementById("".concat(idStr, "_middle_name"))) {
            document.getElementById("".concat(idStr, "_middle_name")).value = person.middle_name;
          }
          if (document.getElementById("".concat(idStr, "_last_name"))) {
            document.getElementById("".concat(idStr, "_last_name")).value = person.last_name;
          }
        }
      });
    }
  ...
  return _createClass(_default, [{
    ...
    value: function initialize() {
      ...
      if (!this.brickSearchSelect && this.hasBrickSearchTarget) {
        this.brickSearchSelect = new tom_select__WEBPACK_IMPORTED_MODULE_1___default.a(this.brickSearchTarget, _defineProperty(_defineProperty(_defineProperty({
          ...
          create: false,
          hideSelected: true
        }, "placeholder", 'Search for a brick by title'), "load", function load(query, callback) {
          if (!query.length) return callback();
          fetch("/bricks_by_title_search?q=".concat(encodeURIComponent(query))).then(function (response) {
            return response.json();
          }).then(function (json) {
            json.sort(function (a, b) {
              return a.title.localeCompare(b.title);
            });
            json.forEach(function (brick) {
              return _this2.brickCache[brick.id] = brick;
            });
            return json.map(function (brick) {
              return {
                id: brick.id,
                title: "".concat(brick.code, " ").concat(brick.title)
              };
            });
          }).then(function (res) {
            return callback(res);
          ...
          var _this2$brickCache;
          var brick = (_this2$brickCache = _this2.brickCache) === null || _this2$brickCache === void 0 ? void 0 : _this2$brickCache[value];
          if (!brick) return;

          // Populate other select fields
          _this2.brickSelect.addOption({
            value: brick.id,
            text: "".concat(brick.code, " ").concat(brick.title)
          });
          _this2.brickSelect.setValue(brick.id, true);
          _this2.brickSelect.refreshOptions(false);
          _this2.klassSelect.addOption({
            value: brick.klass.id,
            text: "".concat(brick.klass.code, " ").concat(brick.klass.title)
          });
          _this2.klassSelect.setValue(brick.klass.id, true);
          _this2.brickSelect.refreshOptions(false);
          _this2.familySelect.addOption({
            value: brick.family.id,
            text: "".concat(brick.family.code, " ").concat(brick.family.title)
          });
          _this2.familySelect.setValue(brick.family.id, true);
          _this2.familySelect.refreshOptions(false);
          _this2.segmentSelect.addOption({
            value: brick.segment.id,
            text: "".concat(brick.segment.code, " ").concat(brick.segment.title)
          });
          _this2.segmentSelect.setValue(brick.segment.id, true);
          _this2.segmentSelect.refreshOptions(false);
        }));
      }
...
_default.targets = ["brickSearch", "segment", "family", "klass", "brick"];
...
/* harmony import */ var _pit_cit_capture_ajax_directives__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./pit_cit_capture_ajax_directives */ "./app/javascript/packs/pit_cit_capture_ajax_directives.js");
/* harmony import */ var _pit_cit_capture_ajax_directives__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_pit_cit_capture_ajax_directives__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js");
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(jquery__WEBPACK_IMPORTED_MODULE_6__);
/* harmony import */ var _nathanvda_cocoon__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @nathanvda/cocoon */ "./node_modules/@nathanvda/cocoon/cocoon.js");
/* harmony import */ var _nathanvda_cocoon__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(_nathanvda_cocoon__WEBPACK_IMPORTED_MODULE_7__);
...
/***/ "./app/javascript/packs/pit_cit_capture_ajax_directives.js":
/*!*****************************************************************!*\
  !*** ./app/javascript/packs/pit_cit_capture_ajax_directives.js ***!
  \*****************************************************************/
/*! no static exports found */
...
document.addEventListener("turbolinks:load", function () {
  document.querySelectorAll(".nav-tabs a").forEach(function (tab) {
    tab.addEventListener("click", function (event) {
      ...
      var container = pane.querySelector(".tab-content-body");

      // Avoid reloading on repeat clicks
      if (container.dataset.loaded === "true") return;
      container.innerHTML = "<div class='spinner-border'></div>";
      var urlObj = new URL(window.location.href);
      var filter_by = urlObj.searchParams.get("filter_by");
      var apiUrl = url;
      if (filter_by) {
        apiUrl += "?filter_by=".concat(filter_by);
      }
      fetch(apiUrl, {
        headers: {
...
if (window.location.pathname === "/pit_interface" || window.location.pathname === "/cit_interface") {
  document.addEventListener("click", function (event) {
    var link = event.target.closest(".custom-paginate a");
    if (!link) return;
    event.preventDefault();
    var url = new URL(window.location.href);
    var filter_by = url.searchParams.get("filter_by");
    var apiUrl = link.href;
    if (filter_by) {
      apiUrl += "?filter_by=".concat(filter_by);
    }
    fetch(apiUrl, {
...
/******/ });
//# sourceMappingURL=application-92cd99791278622c994a.js.map