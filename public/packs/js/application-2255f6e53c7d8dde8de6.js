...
var _default = /*#__PURE__*/function (_Controller) {
  ...
  return _createClass(_default, [{
    ...
    value: function connect() {
      var _this = this;
      if (this.selectInstance) return;
      this.selectInstance = tom_select__WEBPACK_IMPORTED_MODULE_1___default()(this.element, {
        valueField: 'id',
        ...
        onItemAdd: function onItemAdd(value) {
          ...
          if (person.picture && _this.hasPhotoTarget) {
            _this.photoTarget.value = person.picture;
          }
          if (person.picture && _this.hasPhotoPreviewTarget) {
            _this.photoPreviewTarget.src = person.picture;
...
/******/ });
//# sourceMappingURL=application-2255f6e53c7d8dde8de6.js.map