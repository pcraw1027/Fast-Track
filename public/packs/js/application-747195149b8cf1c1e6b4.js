  ...
  return _createClass(_default, [{
    ...
    value: function () {
      var _submitAdd = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(event) {
        var _this = this;
        var barcode, formData, response, data;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              event.preventDefault();
              console.log("Add button clicked - form will be submitted", event.target.value);
            ...
            case 16:
              ...
              if (Array.isArray(data.bit_records)) {
                data.bit_records.forEach(function (record) {
                  _this.displayTarget.insertAdjacentHTML("afterbegin", "\n               <tr>\n                <td>".concat(record.barcode, "</td>\n                <td>").concat(record.status, "</td>\n                <td>").concat(record.source, "</td>\n                <td>").concat(record.user_id, "</td>\n                <td>").concat(_this.formatDate(record.created_at), "</td>\n                <td>").concat(record.message, "</td>\n              </tr>\n            "));
                });
              }
    ...
    value: function showError(message) {
      ...
      setTimeout(function () {
        _this3.errorTarget.classList.add("d-none");
        _this3.errorTarget.textContent = "";
      }, 5000);
    }
  }, {
    key: "formatDate",
...
/******/ });
//# sourceMappingURL=application-747195149b8cf1c1e6b4.js.map