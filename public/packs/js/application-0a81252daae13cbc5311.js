...
var _default = /*#__PURE__*/function (_Controller) {
  ...
  return _createClass(_default, [{
    ...
    //   try {
    //     const response = await fetch(`/bricks_by_title_search?q=${encodeURIComponent(query)}`)
    //     const json = await response.json()
    //     this.brickCache = {} 
    //     json.forEach(brick => this.brickCache[brick.id] = brick)
    //     const options = json.map((brick) => ({
    //       id: brick.id,
...
/******/ });
//# sourceMappingURL=application-0a81252daae13cbc5311.js.map