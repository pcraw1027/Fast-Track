...
var _default = /*#__PURE__*/function (_Controller) {
  ...
  return _createClass(_default, [{
    ...
    value: function initBrickTitleSearch() {
      var _this2 = this;
      if (this.selectInstance || this.element.tagName.toLowerCase() !== "select") return;
      this.brickCache = {};
      this.selectInstance = new tom_select__WEBPACK_IMPORTED_MODULE_1___default.a(this.element, {
        valueField: 'id',
        labelField: 'title',
        ...
        onItemAdd: function onItemAdd(value) {
          ...
          if (!brick) return;
          console.log("Has brick target?", _this2.hasBrickTarget);
          console.log("Has segment target?", _this2.hasSegmentTarget);
          console.log("Has family target?", _this2.hasFamilyTarget);
          console.log("Has klass target?", _this2.hasKlassTarget);
...
/******/ });
//# sourceMappingURL=application-474a49c1118aeaad0e33.js.map